...
c---------------------------------------------------------------------
      ...
      subroutine read_input(graphname, init_con, width, depth)
...
c---------------------------------------------------------------------
      ...
      include 'applu.incl'
      character class, graphname*2

      integer   fstatus, width, depth, init_con, col_indx
