...
c---------------------------------------------------------------------
     ...
     >   qs      (    0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX-1),
     >   rho_i   (    0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX-1),
     >   speed   (    0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX-1),
     >   square  (    0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX-1),
...
c--------------------------------------------------------------------
c   For NGBs we add a common block containing verification values
c--------------------------------------------------------------------

      double precision xcrref(5), xceref(5)
      common /NGBcons/ xcrref, xceref
