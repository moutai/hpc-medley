...
void write_sp_info(FILE *fp, int nprocs, char class) 
{
  ...
  fprintf(fp, "%sinteger max_xysize\n", FINDENT);
  fprintf(fp, "%sparameter (max_xysize=%d)\n", FINDENT, 
      	  max_xysize);
		   ...
		   int *max_xysize, int *max_lsize)
{
   ...
   int proc_zone_size[num_procs], proc_zone_size2[num_procs];
#ifndef BLOAD_NO_COMM
...
/* ... use a simple scheme to balance the load among processes */
