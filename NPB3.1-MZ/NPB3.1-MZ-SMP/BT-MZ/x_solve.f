...
!$OMP&  SHARED(dx5,dx4,dx3,dx2,dx1,tx2,tx1,dt,c1345,c3c4,con43,c1,c2,ny,
!$OMP& nz,nx)
      isize = nx-1
...
c---------------------------------------------------------------------
     ...
     >              - tmp1 * dx5
               ...
               lhs(1,1,bb,i) = 1.d0
     >              + tmp1 * 2.d0 * njac(1,1,i)
     >              + tmp1 * 2.d0 * dx1
               lhs(1,2,bb,i) = tmp1 * 2.d0 * njac(1,2,i)
               lhs(1,3,bb,i) = tmp1 * 2.d0 * njac(1,3,i)
               lhs(1,4,bb,i) = tmp1 * 2.d0 * njac(1,4,i)
               lhs(1,5,bb,i) = tmp1 * 2.d0 * njac(1,5,i)

               lhs(2,1,bb,i) = tmp1 * 2.d0 * njac(2,1,i)
               lhs(2,2,bb,i) = 1.d0
     >              + tmp1 * 2.d0 * njac(2,2,i)
     >              + tmp1 * 2.d0 * dx2
               lhs(2,3,bb,i) = tmp1 * 2.d0 * njac(2,3,i)
               lhs(2,4,bb,i) = tmp1 * 2.d0 * njac(2,4,i)
               lhs(2,5,bb,i) = tmp1 * 2.d0 * njac(2,5,i)

               lhs(3,1,bb,i) = tmp1 * 2.d0 * njac(3,1,i)
               lhs(3,2,bb,i) = tmp1 * 2.d0 * njac(3,2,i)
               lhs(3,3,bb,i) = 1.d0
     >              + tmp1 * 2.d0 * njac(3,3,i)
     >              + tmp1 * 2.d0 * dx3
               lhs(3,4,bb,i) = tmp1 * 2.d0 * njac(3,4,i)
               lhs(3,5,bb,i) = tmp1 * 2.d0 * njac(3,5,i)

               lhs(4,1,bb,i) = tmp1 * 2.d0 * njac(4,1,i)
               lhs(4,2,bb,i) = tmp1 * 2.d0 * njac(4,2,i)
               lhs(4,3,bb,i) = tmp1 * 2.d0 * njac(4,3,i)
               lhs(4,4,bb,i) = 1.d0
     >              + tmp1 * 2.d0 * njac(4,4,i)
     >              + tmp1 * 2.d0 * dx4
               lhs(4,5,bb,i) = tmp1 * 2.d0 * njac(4,5,i)

               lhs(5,1,bb,i) = tmp1 * 2.d0 * njac(5,1,i)
               lhs(5,2,bb,i) = tmp1 * 2.d0 * njac(5,2,i)
               lhs(5,3,bb,i) = tmp1 * 2.d0 * njac(5,3,i)
               lhs(5,4,bb,i) = tmp1 * 2.d0 * njac(5,4,i)
               lhs(5,5,bb,i) = 1.d0
     >              + tmp1 * 2.d0 * njac(5,5,i)
     >              + tmp1 * 2.d0 * dx5
