...
c---------------------------------------------------------------------
      ...
      subroutine y_solve(rho_i, qs, square, u, rhs, nx, nxmax, ny, nz)
...
!$OMP&  SHARED(dy5,dy4,dy3,dy2,dy1,ty2,ty1,dt,c1345,con43,c3c4,c1,c2,nx,
!$OMP& nz,ny)
      jsize = ny-1
...
c---------------------------------------------------------------------
     ...
     >              - tmp1 * dy5
               ...
               lhs(1,1,bb,j) = 1.d0
     >              + tmp1 * 2.d0 * njac(1,1,j)
     >              + tmp1 * 2.d0 * dy1
               lhs(1,2,bb,j) = tmp1 * 2.d0 * njac(1,2,j)
               lhs(1,3,bb,j) = tmp1 * 2.d0 * njac(1,3,j)
               lhs(1,4,bb,j) = tmp1 * 2.d0 * njac(1,4,j)
               lhs(1,5,bb,j) = tmp1 * 2.d0 * njac(1,5,j)

               lhs(2,1,bb,j) = tmp1 * 2.d0 * njac(2,1,j)
               lhs(2,2,bb,j) = 1.d0
     >              + tmp1 * 2.d0 * njac(2,2,j)
     >              + tmp1 * 2.d0 * dy2
               lhs(2,3,bb,j) = tmp1 * 2.d0 * njac(2,3,j)
               lhs(2,4,bb,j) = tmp1 * 2.d0 * njac(2,4,j)
               lhs(2,5,bb,j) = tmp1 * 2.d0 * njac(2,5,j)

               lhs(3,1,bb,j) = tmp1 * 2.d0 * njac(3,1,j)
               lhs(3,2,bb,j) = tmp1 * 2.d0 * njac(3,2,j)
               lhs(3,3,bb,j) = 1.d0
     >              + tmp1 * 2.d0 * njac(3,3,j)
     >              + tmp1 * 2.d0 * dy3
               lhs(3,4,bb,j) = tmp1 * 2.d0 * njac(3,4,j)
               lhs(3,5,bb,j) = tmp1 * 2.d0 * njac(3,5,j)

               lhs(4,1,bb,j) = tmp1 * 2.d0 * njac(4,1,j)
               lhs(4,2,bb,j) = tmp1 * 2.d0 * njac(4,2,j)
               lhs(4,3,bb,j) = tmp1 * 2.d0 * njac(4,3,j)
               lhs(4,4,bb,j) = 1.d0
     >              + tmp1 * 2.d0 * njac(4,4,j)
     >              + tmp1 * 2.d0 * dy4
               lhs(4,5,bb,j) = tmp1 * 2.d0 * njac(4,5,j)

               lhs(5,1,bb,j) = tmp1 * 2.d0 * njac(5,1,j)
               lhs(5,2,bb,j) = tmp1 * 2.d0 * njac(5,2,j)
               lhs(5,3,bb,j) = tmp1 * 2.d0 * njac(5,3,j)
               lhs(5,4,bb,j) = tmp1 * 2.d0 * njac(5,4,j)
               lhs(5,5,bb,j) = 1.d0
     >              + tmp1 * 2.d0 * njac(5,5,j) 
     >              + tmp1 * 2.d0 * dy5
