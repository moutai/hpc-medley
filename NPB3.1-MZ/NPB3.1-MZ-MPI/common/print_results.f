      ...
      subroutine print_results(name, class, n1, n2, n3, niter, t, 
     >               mops, num_procs, tot_threads, optype, 
     ...
     >               cs1, cs2, cs3, cs4, cs5, cs6, cs7)
      ...
      character name*(*)
      character class*1
      integer   n1, n2, n3, niter, num_procs, tot_threads, j
...
c   Otherwise, we print the grid size n1xn2xn3
 ...
 44            format(' Size            = ',12x, i12)
            ...
            write (*, 4) n1,n2,n3
 4          format(' Size            =  ',10x, i4,'x',i4,'x',i3)
         endif
