...
c---------------------------------------------------------------------
     ...
     $        nz(num_zones), 
     $        start1(num_zones), start5(num_zones),
...
c---------------------------------------------------------------------
      ...
      double precision u    (5*IMAX*JMAX*KMAX),
     >                 rsd  (5*IMAX*JMAX*KMAX),
     >                 frct (5*IMAX*JMAX*KMAX),
     >                 qs   (  IMAX*JMAX*KMAX),
...
c---------------------------------------------------------------------
     ...
     $                 phi2(problem_size*problem_size)
      ...
      integer i, fstatus, n3, zone, step
